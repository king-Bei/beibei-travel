        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-luxury-dark border border-white/10 rounded-sm p-8 md:p-12">
            ...
            <div id="dive-sites" className="mb-12">
              <h2 className="text-2xl md:text-3xl font-playfair mb-6 text-luxury-gold">🏝️ 最佳潛點介紹</h2>
              <p className="text-lg leading-relaxed text-luxury-cream/80 mb-6">
              ...
              <div className="space-y-6 my-8">
                ...
                <div className="bg-luxury-black p-6 rounded-lg border border-white/5">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-3xl">�壁</span>
                ...
                <table className="w-full border-collapse">
                  ...
                  <tbody>
                    <tr className="border-b border-white/5">
                      ...
                      <td className="py-4 px-4"><span className="text-green-400">⭐⭐⭐⭐⭐</span></td>
                    ...
                    <tr className="border-b border-white/5">
                      ...
                      <td className="py-4 px-4"><span className="text-yellow-400">⭐⭐⭐⭐</span></td>
            ...
            <div id="marine-life" className="mb-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 my-8">
                {[
                  { name: "黑鰭礁鯊", emoji: "🦈", desc: "幾乎每次潛水都能看到" },
                  { name: "蘇眉魚", emoji: "🐟", desc: "帛琉的明星魚之一" },
                  { name: "海龜", emoji: "🐢", doc: "到處都有" },
                  { name: "Manta Ray", emoji: "🦑", desc: "優雅的海中巨人" },
                  { name: "Eagle Ray", emoji: "🦅", desc: "飛行般的泳姿" },
                  { name: "黃金水母", emoji: "🪼", desc: "水母湖限定" },
                ].map((item) => (
                  <div key={item.name} className="bg-luxury-black p-4 rounded-lg border border-white/5 text-center">
            ...
            <div id="cost" className="mb-12">
              ...
              <div className="space-y-4 my-8">
                <div className="bg-luxury-black p-6 rounded-lg border border-white/5">
                  <h3 className="text-xl font-bold mb-4">✈️ 機票</h3>
                  <ul className="space-y-2 text-luxury-muted">
                    <li>• 台北→帛琉：約 $600-900 USD（來回）</li>
                    <li>• 建議提前 2-3 個月預訂</li>
                    <li>• 華航、帛琉航空有直飛包機</li>
                  </ul>
                </div>
              ...
              <div className="space-y-4 my-8">
                ...
                <div className="flex items-start gap-4 p-4 bg-luxury-black rounded-lg border border-white/5">
                  ...
                  <div>
                    ...
                    <p className="text-luxury-muted text-test">住宿科羅爾（Koror）市區，比度假村便宜 50% 以上</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-luxury-black rounded-lg border border-white/5">
